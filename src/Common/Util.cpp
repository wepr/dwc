...
std::string get_nix_version_display_string()
{
  ...
  {
    //namespace fs = boost::filesystem;
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\CRYPTONOTE_TICKER
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\CRYPTONOTE_TICKER
    // Mac: ~/Library/Application Support/CRYPTONOTE_TICKER
    // Unix: ~/.CRYPTONOTE_TICKER
    std::string config_folder;
#ifdef WIN32
    // Windows
    config_folder = get_special_folder_path(CSIDL_APPDATA, true) + "/" + CryptoNote::CRYPTONOTE_TICKER;
#else
    std::string pathRet;
    ...
    config_folder =  (pathRet + "/" + CryptoNote::CRYPTONOTE_TICKER);
#else
    // Unix
    config_folder = (pathRet + "/." + CryptoNote::CRYPTONOTE_TICKER);
#endif
